...
function defaultWsUrl(): string {
  ...
  return `${protocol}//std-wt03.stdp.ru/services/main_ws_service`;
}
...
function App() {
  ...
  const [statefulSocketId, setStatefulSocketId] = useState<string>(
    () =>
      sessionStorage.getItem(SOCKET_ID_STORAGE_KEY) ??
      "ws-user-7079554317075315721",
  );
  ...
  const startHeartbeat = () => {
    ...
    const intervalSeconds =
      Number.isFinite(heartbeatSeconds) && heartbeatSeconds >= 5
        ? heartbeatSeconds
        : 30;
  ...
  const connect = () => {
    try {
      ...
      socket.onclose = (event) => {
        ...
        appendLog(
          `Закрыто: code=${event.code}, reason=${event.reason || "no_reason"}`,
        );
      };
    } catch (error) {
    ...
    <div className="app">
      ...
      <section className="panel">
        ...
        <input
          ...
          placeholder="wss://std-wt03.stdp.ru/services/main_ws_service"
        />
        ...
        <input
          ...
          placeholder="Например: ws-user-7079554317075315721"
        />
        ...
        <div className="controls">
          ...
          <button
            type="button"
            onClick={() => disconnect(1000, "manual")}
      ...
      <section className="panel">
        ...
        <div className="heartbeat-grid">
          ...
          <input
            ...
            onChange={(event) =>
              setHeartbeatSeconds(Number(event.target.value || 30))
            }
          />
          <button
            type="button"
